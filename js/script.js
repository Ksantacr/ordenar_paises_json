...
obj.forEach(function(element) {
  ...
  for(var prop in element){
   ...
   if(paises.indexOf(element[prop])==-1){
      paises.push(element[prop]); 
   }
...
paises.forEach(function(pais){
  ...
  var templatePais = "<td>pais</td>";
  templatePais = templatePais.replace("pais", pais);
  var tr = document.createElement("tr");
  tr.innerHTML = "<tr>"+templatePais+"</tr>"
